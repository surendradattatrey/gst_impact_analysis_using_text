...
# Read Stopwords list
stpw1 = readLines('C:\\Users\\Yash\\Desktop\\ISB Documents\\Term 1\\TABA\\Amit Session Files\\Session 1 Materials-20170424\\stopwords.txt')      #
...
wordcloud(names(v), v, scale=c(8,1),1, max.words=100,colors=brewer.pal(8, "Dark2"))
title(sub = "GST impact on Manufacturing Positive Words - Wordcloud")
...
title(sub = "GST impact on Manufacturing Negative Words - Wordcloud")
...
title(main = "GST impact on Manufacturing Positive words vs Negative Words" )
...
abline(h=0)
title(main = "GST impact on Manufacturing Polarity Plot" )
